...
/**
 * RLP Responsive core renderers.
 *
 * @package    theme_rlp_responsive (Basis Clean Theme)
 * @copyright  2015 Frédéric Massart - FMCorz.net
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_rlp_responsive_core_renderer extends theme_bootstrapbase_core_renderer {
