...
require_once(__DIR__ . '/behat_theme_boost_arbeitsplaner_behat_files.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_boost_arbeitsplaner_behat_filepicker extends behat_theme_boost_arbeitsplaner_behat_files {
    /**
