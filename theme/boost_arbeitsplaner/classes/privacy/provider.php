...
/**
 * Privacy Subsystem implementation for theme_boost_arbeitsplaner.
 *
...
namespace theme_boost_arbeitsplaner\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_boost_arbeitsplaner');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_boost_arbeitsplaner');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_boost_arbeitsplaner',
